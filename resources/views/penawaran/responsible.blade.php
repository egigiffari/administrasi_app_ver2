        ...
        <div class="x_content">
            <div class="row">
                <div class="col-sm-12 col-md-6 col-xl-6">
                    <form action="{{ route('penawaran.add_responsible') }}" method="post" data-parsley-validate class="form-horizontal form-label-left">    
                        @csrf
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('penawaran.destroy_responsible', $responsible->id) }}" method="post">
                                        @csrf
                                        @method('delete')
