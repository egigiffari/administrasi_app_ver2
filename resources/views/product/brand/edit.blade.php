...
<div class="row">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_content"> 
                    <form action="{{ route('brand.update', $brand->id) }}" method="post" data-parsley-validate class="form-horizontal form-label-left" >    
                        @csrf
                        @method('patch')
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" value="{{ $brand->name }}" id="autocomplete-custom-append" name="name" required="required" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
