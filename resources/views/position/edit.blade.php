...
@section('title-content', 'Edit Position')
@section('content')
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_content"> 
                <form action="{{ route('position.update', $position->id) }}" method="post" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">    
                    @csrf
                    @method('patch')
                    <div class="row">
                        <div class="col-sm-12 col-md-6 col-xl-6 col-md-offset-3">
                            ...
                            <div class="col-xs-12 form-group has-feedback">
                                ...
                                <input class="form-control" value="{{ $position->name }}" name="name" id="inputSuccess6" type="text" placeholder="Name">
                            </div>
